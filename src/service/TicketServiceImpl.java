...
public class TicketServiceImpl implements  TicketService{
    ...
    @Override
    public Ticket createTicket(Vehicle vehicle, int gateId, int parkingLotId, LocalDateTime entryTime) throws GateNotFoundException, NoParkingSlotAvailableException, ParkingLotNotFoundException {
